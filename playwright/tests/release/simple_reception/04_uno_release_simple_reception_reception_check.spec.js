...
test('Simple Reception > Reception register to delete', async ({ page }) => { 
  ...
  await simpleReception.selectReception();
  await simpleReception.checkReceptionSuccessText();
  
  await simpleReception.closeSimpleReceptionModal();
  await simpleReception.checkMovedToMain();

  await simpleReception.moveToCalendar();

  await simpleReception.enterInIntegratedChart();
  await simpleReception.enterReception();

  await simpleReception.deleteReception();
  await simpleReception.checkDeleteSuccessText();
