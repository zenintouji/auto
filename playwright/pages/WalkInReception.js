...
class WalkInReception {
    constructor(page) {
        ...
        this.cancelReceptionButton = page.getByRole('button', { name: '접수취소' }).nth(1);
        ...
        // 항목 선택
        this.selectChart = page.locator('div:nth-child(2) > .sc-hmdomO > .sc-bXCLTC > tr > td').first();
        ...
        this.page.getByRole('cell', { name: '안주영' }).nth(0);
    ...
    async selectType() {
        ...
        await expect(this.receptionType).toBeVisible();
        await this.receptionType.click();
        await this.page.waitForLoadState('domcontentloaded');
